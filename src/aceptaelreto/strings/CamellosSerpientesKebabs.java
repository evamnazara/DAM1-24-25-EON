...
public class CamellosSerpientesKebabs {
    ...
    public static void main(String[] args) {
        ...
        while (sc.hasNextLine()) {
            ...
            // Separar el nombre de la variable y el tipo de notación a la que se quiere convertir
    ...
    private static String toCamelCase(String variable) {
        ...
        for (int i = 0; i < words.length; i++) {
            if (i == 0) {
                ...
                result += words[i].substring(0, 1).toUpperCase() + words[i].substring(1).toLowerCase();  // Palabras siguientes con la primera letra en mayúscula
            }
        }
