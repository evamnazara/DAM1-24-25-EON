...
public class TeclasDElPiano {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // Crear un array para contar las pulsaciones de cada tecla (12 teclas por 7 octavas)
            ...
            for (String nota : canciones) {
                ...
                // Si la nota es válida, incrementamos el contador de esa tecla en la octava correcta
                if (index != -1) {
                    // Ahora, con la octava como string, determinamos a qué octava pertenece.
                    int octavaIndex = 0;
                    if (octava.equals("1")) octavaIndex = 0;
                    else if (octava.equals("2")) octavaIndex = 1;
                    else if (octava.equals("3")) octavaIndex = 2;
                    else if (octava.equals("4")) octavaIndex = 3;
                    else if (octava.equals("5")) octavaIndex = 4;
                    else if (octava.equals("6")) octavaIndex = 5;
                    else if (octava.equals("7")) octavaIndex = 6;
...
El teclado del piano está compuesto por 7 octavas1 y cada octava consta de 12 notas (7 blancas y 5 negras) cada una a medio tono de distancia de la siguiente. Las teclas blancas corresponden a las notas Do, Re, Mi, Fa, Sol, La y Si (y a continuación vendrá el Do de la siguiente octava). Entre las notas Do y Re hay un tono de distancia por lo que hay una tecla negra en medio, mientras que entre Mi y Fa sólo hay medio tono de distancia. Las teclas negras corresponden precisamente a esos medios tonos y se nombran usando dos símbolos especiales: sostenido (♯) y bemol (♭). El sostenido aumenta medio tono mientras que el bemol disminuye medio tono.

De esta forma, la primera tecla negra de la octava corresponde a la nota Do ♯ pero también a Re ♭. Para liar un poco más las cosas la nota Mi ♯ está en la misma tecla que Fa, y un Do ♭ es lo mismo que el Si de la octava anterior.
...
/*Para resolver este problema, necesitamos contar cuántas veces se pulsa cada tecla de un piano, dado un conjunto de notas de una canción. Las teclas del piano están distribuidas en octavas, y las notas pueden ser blancas (sin alteración) o negras (con alteración de sostenido o bemol). Las octavas van de la 1 a la 7 y las notas son representadas en un formato como "Do4", "Re#5", etc.

Pasos para la solución:
Entender la estructura del teclado del piano:
Las notas son: Do, Re, Mi, Fa, Sol, La, Si.
Las teclas negras son: Do# (o Reb), Re# (o Mib), Fa# (o Solb), Sol# (o Lab), La# (o Sib).
...
Salida:
Para cada canción, debemos contar cuántas veces se ha tocado cada tecla del piano, desde la más grave hasta la más aguda.
Plan de solución:
Inicializar un array para contar las pulsaciones:
Un piano tiene 12 teclas por octava, por lo que necesitamos contar las teclas de todas las octavas (de la octava 1 a la octava 7).
Convertir las notas a índices del teclado:
Cada nota, por ejemplo, "Do4", debe ser convertida en un índice que corresponda a su tecla específica. "Do4" será la primera tecla de la octava 4.
Contar las pulsaciones:
Vamos a recorrer las notas y contar cuántas veces aparece cada una.
Salida:
Para cada canción, imprimir las pulsaciones de las teclas, desde la más grave a la más aguda. */