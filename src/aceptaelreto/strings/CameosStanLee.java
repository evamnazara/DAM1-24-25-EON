...
public class CameosStanLee {
    ...
    public static int contarCameos(String frase) {
        ...
        // El nombre a buscar es "stan lee", que se debe encontrar en la frase con caracteres intermedios
    ...
    public static int buscarCameoEnFrase(String frase, int inicio, String cameo) {
        ...
        for (int i = inicio; i < frase.length(); i++) {
            ...
            // Si encontramos una letra, la comparamos con la letra correspondiente en "stan lee"
...
Aparte de por haber creado infinidad de superhéroes, Stan Lee es recordado por los cameos cinematográficos que hizo en mutitud de películas y series.
