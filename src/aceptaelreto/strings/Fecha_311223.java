...
Entrada
La entrada comienza con un número que indica cuántos casos deberán procesarse. Cada caso de prueba son tres números entre 0 y 99 escritos con dos dígitos.

Salida
Por cada caso de prueba se escribirá DIVERTIDOS si hay una forma de ordenar los tres números de modo que formen dos bloques de 3 dígitos iguales, e INSULSOS en otro caso.
