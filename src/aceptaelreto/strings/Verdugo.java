...
public class Verdugo {
    ...
    public static String ahorcado(String palabra, String propuestas) {
        ...
        for (int i = 0; i < propuestas.length(); i++) {
            ...
            // Si ya ha sido resuelto o se ha alcanzado el límite de fallos, ignoramos más propuestas
...
Entrada
Cada caso de prueba está formado por dos líneas, cada una con una secuencia de no más de 100 letras minúsculas del alfabeto inglés sin espacios. La primera representa la palabra oculta. La segunda contiene las letras propuestas por el adivinador, entre las que podría haber algunas repetidas.
...
El adivinador podría repetir algunas letras. En ese caso, las segundas apariciones no contarán como fallo (lo fueran o no en su primera aparición). Además, en la entrada podrían aparecer letras posteriores dadas por el adivinador después de haberse salvado o de haber sido condenado, que deben ignorarse.
