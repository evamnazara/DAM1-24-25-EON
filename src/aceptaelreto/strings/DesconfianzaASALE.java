...
public class DesconfianzaASALE {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numeroDeCasos; i++) {
            ...
            // Llamamos a la función que compara las palabras siguiendo las reglas del antiguo diccionario
    ...
    public static String compararPalabras(String palabra1, String palabra2) {
        // Reemplazamos "ch" por "ç" y "ll" por "ë" para tratarlos como caracteres únicos
