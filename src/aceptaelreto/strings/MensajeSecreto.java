...
public class MensajeSecreto {
    ...
    public static String descifrarMensaje(String mensajeCifrado) {
        ...
        while (i < mensajeCifrado.length()) {
            // Intentamos obtener el siguiente número, que puede tener 2 o 3 dígitos (por ejemplo: 65 o 100)
            int codigoAscii;
            if (i + 2 < mensajeCifrado.length() && esNumero(mensajeCifrado.charAt(i)) && esNumero(mensajeCifrado.charAt(i + 1)) && esNumero(mensajeCifrado.charAt(i + 2))) {
    ...
    // Función para verificar si un carácter es un número (para determinar si es parte de un código ASCII)
...
Entrada
La entrada está formada por un conjunto de mensajes codificados, cada uno en una línea distinta. Los mensajes pueden contener sólo letras mayúsculas y minúsculas del alfabeto inglés, además de los símbolos espacio, coma y punto. La longitud un mensaje, después de ser descifrado, no es nunca mayor de 100 caracteres.
