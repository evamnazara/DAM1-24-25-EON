...
public class YoLoColoco {
    ...
    public static String limpiarFrase(String frase) {
        // Convertimos la frase a minúsculas para no distinguir entre mayúsculas y minúsculas
...
El calambur suele basarse en la forma en la que las palabras suenen por lo que en ocasiones las letras en ambas interpretaciones no coinciden. Por ejemplo ocurre con "¿Por qué lavó la rueda?" frente a "¿Por qué la bola rueda?". Otras veces (las menos) las dos interpretaciones tienen exactamente las mismas letras pero al leerlos suenan de forma muy distinta, como "Servil, letal, impía" y "Servilleta límpia".
...
Por cada caso de prueba aparecerán dos líneas, una con cada frase. Las líneas estarán formadas exclusivamente por letras del alfabeto inglés (no habrá eñes ni vocales acentuadas, por ejemplo), espacios y signos de puntuación (puntos, comas, dos puntos o punto y coma).
