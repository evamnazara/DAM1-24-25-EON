...
public class AdaAlanCompania {
    ...
    // Función que devuelve la longitud del palíndromo más largo dentro de una palabra
    public static int encontrarPalindromoMasLargo(String palabra) {
        ...
        for (int i = 0; i < palabra.length(); i++) {
            ...
            for (int j = i + 1; j <= palabra.length(); j++) {
                ...
                // Si la subcadena es un palíndromo y su longitud es mayor a la máxima encontrada
    ...
    public static boolean esPalindromo(String subcadena) {
        ...
        // Comprobamos si el primer y último carácter son iguales, y repetimos con los caracteres internos
        while (inicio < fin) {
