...
public class FuerzasImperiales {
    ...
    // Función para verificar si una posición es válida (dentro de los límites y no es un asteroide)
        ...
        for (int c = 0; c < casos; c++) {
            ...
            for (int i = 0; i < filas; i++) {
                ...
                for (int j = 0; j < columnas; j++) {
                    ...
                    if (campo[i][j] == 'S') {
                        sx = i; sy = j; // Guardamos la posición de la entrada
                    }
                    if (campo[i][j] == 'F') {
                        fx = i; fy = j; // Guardamos la posición de la salida
                    }
                }
            }
