...
/*
 * Pantallas de carga
Comparación de la carátula y la pantalla de presentación del NavyMoves de Dinamic y Luis Royo
...
El ZX Spectrum, por ejemplo, solo era capaz de mostrar 15 colores1, y no todos a la vez. En concreto, la pantalla se dividía en bloques de 8×8 píxeles, y en cada bloque solo podían usarse dos colores distintos. De esta forma, con su resolución de 256×192 la pantalla quedaba dividida en una cuadrícula de 32×24 celdas de 8×8 píxeles, y cada una solo podía mostrar 2 de los 15 colores.
