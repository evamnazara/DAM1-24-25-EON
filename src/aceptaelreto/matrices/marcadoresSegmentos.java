...
public class MarcadoresSegmentos {
    ...
    public static void main(String[] args) {
        ...
        // Cada número se representa como un entero de 7 bits donde 1 indica encendido y 0 apagado
        int[] segmentos = {
            0b1111110,  // 0
            0b0110000,  // 1
            0b1101101,  // 2
...
Al desplazarse el 1 y entrar el 2 se encienden seis segmentos y se apaga otro, lo que hacen un total de 7 cambios.
En el siguiente desplazamiento, al entrar el 3, se encienden siete segmentos y se apagan dos.
Al desaparecer el 1, el dígito de más a la derecha queda por completo apagado; hay cinco leds que se encienden y siete que se apagan.
La desaparición del 2 provoca otro dígito más apagado por completo y un led que se enciende y 6 que se apagan.
En el último paso se apagan cinco leds quedándose el marcador completo apagado.
Eso hace un total de 42 cambios de luces.

Entrada
La entrada contendrá una línea por cada caso de prueba. En cada línea aparecerá una secuencia de enteros (0 ≤ n ≤ 9) separados por espacios que tendrán el mensaje que se quiere mostrar en el marcador; el fin del mensaje se marca con un -1. El ancho del marcador varía con cada caso de prueba y coincide con el número de dígitos total del mensaje, de forma que todos los mensajes serán completamente visibles durante un instante.
