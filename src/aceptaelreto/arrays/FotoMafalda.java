...
public class FotoMafalda {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // Inicializamos las variables para contar las fotos y la gente que queda sin foto
            int fotosRealizadas = 0;
            int personasSinFoto = 0;

            // Array para controlar si un personaje ya ha sido utilizado o no
            boolean[] personajesOcupados = new boolean[7]; // Mafalda, Felipe, Manolito, Susanita, Miguelito, Libertad, Guille
    ...
    // Método auxiliar para obtener el índice de un personaje en el array de personajes
