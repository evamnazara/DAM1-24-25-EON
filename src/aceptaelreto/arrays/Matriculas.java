...
public class Matriculas {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (letra3 == letrasValidas[0]) { // Si llegamos a 'B', reiniciamos y avanzamos la segunda letra
                ...
                if (letra2 == letrasValidas[0]) { // Si llegamos a 'B' de nuevo, reiniciamos y avanzamos la primera letra
    ...
    // Función que obtiene la siguiente letra válida en el abecedario sin vocales ni Ñ
