...
public class DetectandoCopiones {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            // Leemos el número de exámenes (N) y la cantidad de exámenes que el profesor puede recordar (K)
            System.out.print("Introduce el número de exámenes y la cantidad de exámenes que el profesor puede recordar (N K): ");
            ...
            // Creamos un arreglo para simular la "memoria" del profesor, que almacena las últimas respuestas que puede recordar
