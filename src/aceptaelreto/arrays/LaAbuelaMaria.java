...
public class LaAbuelaMaria {
    ...
    public static void main(String[] args) {
        ...
        for (int caso = 1; caso <= totalCasos; caso++) {
            ...
            // Verificamos si los dientes superiores encajan perfectamente con los inferiores
            boolean encajanPerfectamente = true;
            for (int i = 0; i < 6; i++) {
                // Si los dientes de arriba no coinciden exactamente con los de abajo, no encajan
...
Entrada
La entrada estará formada por distintos casos de prueba, cada uno representando la configuración de dientes de un día en la vida de la abuela María. El número total de casos aparece en la primera línea de la entrada.

Los casos siguen a continuación, cada uno formado por dos líneas. La primera contiene el alto de los seis dientes superiores responsables de la sonrisa (incisivos y caninos) de izquierda a derecha. De forma equivalente, la segunda línea contiene la información de los seis inferiores. Todos ellos son números enteros entre 0 y 2.000.

Salida
Para cada caso de prueba se escribirá SI si los dientes de arriba encajan perfectamente con los de abajo y no quedan huecos entre ninguno de ellos, o NO en caso contrario.
