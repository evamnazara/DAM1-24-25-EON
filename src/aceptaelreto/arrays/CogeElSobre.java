...
Cada caso aparece en dos líneas consecutivas. La primera de ellas contiene dos enteros, el primero con el número de sobres que guarda en el cajón (1 ≤ n ≤ 500.000) y el segundo el número de sobres que tiene que coger para ir a la cena, o lo que es lo mismo, el número de comensales que se llevarán un sobre, incluído el presidente (1 ≤ k ≤ min(n, 200.000)). La segunda línea contiene n números mayores o iguales a 1 con el dinero que hay en cada uno de los sobres.
