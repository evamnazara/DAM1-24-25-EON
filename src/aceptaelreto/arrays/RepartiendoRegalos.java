            ...
            while (true) {
                ...
                for (int j = 0; j < n; j++) {
                    if (!visitados[j]) {
                        ...
                        // Si encontramos una distancia menor o si están igual y el número del portal es mayor
                        if (distancia < minDistancia || (distancia == minDistancia && portales[j] > portalSeleccionado)) {
