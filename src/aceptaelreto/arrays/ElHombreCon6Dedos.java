...
public class ElHombreCon6Dedos {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // Usamos una ventana deslizante para contar los nacimientos en los periodos de A años
            int ventana = 0;
